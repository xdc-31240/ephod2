  ...
  */
  function file_upload(element, options) {
    ...
    var defaults = {
      ...
      messages: {
        default: 'Glissez et déposez le fichier ici ou cliquez pour sélectionner',
        replace: 'Glissez et déposez le fichier ici ou cliquez pour sélectionner',
        remove: 'Effacer',
        error: 'Ooops, something wrong happend.'
      },
      error: {
        fileSize: 'Le fichier est trop grand: ({{ value }} max).',
        minWidth: 'Image trop petite ({{ value }}px min).',
        maxWidth: 'Image trop grande ({{ value }}px max).',
        minHeight: 'Hauteur trop petite  ({{ value }}px min).',
        maxHeight: 'Hauteur trop grande({{ value }}px max).',
        imageFormat: 'Format pas supporté({{ value }} only).',
        fileExtension: 'Fichier réfusé ({{ value }} only).'
      },
      tpl: {
